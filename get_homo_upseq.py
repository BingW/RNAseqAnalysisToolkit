...
def gene_db_init():
    ...
    for genome in genome_list:
        genome_tab_file = ygob_path + genome + "_genome.tab"
        gene_db[genome] = []
...
def load_seq():
    ...
    for genome in genome_list:
        ygob[genome] = {}
        fsa_file = ygob_path + genome + "_sequence.fsa"
...
def write_homo_by_sp(all_homo,name,n):
...
def main():
    ...
    for name in gene_list:
        write_homo_by_genes(name,UP_LEN)

    for name in genome_list:
        write_homo_by_sp(all_homo, name,UP_LEN)
